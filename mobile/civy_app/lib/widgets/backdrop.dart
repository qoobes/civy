...
class BackDropState extends State<BackDrop>
  ...
  Widget _buildStack(BuildContext context, BoxConstraints boxConstraints) {
    ...
    List<Widget> layers = [
      new StreamBuilder(
        stream: TodoProvider.of(context).numItemsOutput,
                  ...
                  child: ScrollConfiguration(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            ...
                            .doc("4f4fe276-9b7e-43c2-8608-858e0c09713e")
                            .collection("tasks")
                            .snapshots(),
                        builder: (context, snapshot) {
  ...
  Widget build(BuildContext context) {
    ...
    List<ShapeBackgroundPainterBuilder> painterBuilders = [
      ...
      (t, c) => [
            ...
            Positioned.fromRect(
              rect: new RectTween(
                begin: new Rect.fromLTWH(c.maxWidth * 0.8, c.maxHeight * 0.79,
                    c.maxWidth * 0.25, c.maxWidth * 0.25),
            ...
            Positioned.fromRect(
              rect: new RectTween(
                begin: new Rect.fromLTWH(-c.maxWidth * 0.1, c.maxHeight * 0.5,
                    c.maxWidth * 0.25, c.maxWidth * 0.25),
